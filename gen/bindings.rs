...
extern "C" {
    #[doc = " Generates vertex buffer from the source vertex buffer and remap table generated by generateVertexRemap"]
    #[doc = ""]
    #[doc = " destination must contain enough space for the resulting vertex buffer (unique_vertex_count elements, returned by generateVertexRemap)"]
...
extern "C" {
    #[doc = " Generate index buffer from the source index buffer and remap table generated by generateVertexRemap"]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " This makes it possible to use the index buffer for Z pre-pass or shadowmap rendering, while using the original vertex/index buffers elsewhere."]
    #[doc = ""]
    #[doc = " destination must contain enough space for the resulting index buffer (index_count elements)"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " destination must contain enough space for the resulting index buffer (index_count elements)"]
    #[doc = " indices must contain index data that is the result of optimizeVertexCache (*not* the original mesh indices!)"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " buffer must contain enough space for the encoded index buffer (use meshopt_encodeIndexBufferBound to estimate)"]
...
extern "C" {
    ...
    #[doc = " Returns encoded data size on success, 0 on error"]
    #[doc = ""]
    #[doc = " buffer must contain enough space for the encoded vertex buffer (use meshopt_encodeVertexBufferBound to estimate)"]
...
pub struct meshopt_Bounds {
    ...
    pub cone_cutoff: f32,
    pub cone_axis_s8: [::std::os::raw::c_char; 3usize],
    pub cone_cutoff_s8: ::std::os::raw::c_char,
}
extern "C" {
